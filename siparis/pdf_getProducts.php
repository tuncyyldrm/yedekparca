...
$itemsPerPage = 1000; // Sayfa başına ürün sayısı
...
$charLimit = 85;
$truncatedProductInfo = strlen($productInfo) > $charLimit ? substr($productInfo, 0, $charLimit) . '...' : $productInfo;
...
if (isset($_SESSION['user'])) {
    ...
    // Diğer roller için bir işlem ekleyebilirsiniz
        ...
        echo "<div class='flex flex-col justify-center items-center bg-white '>";
        echo "<div class='bg-white shadow-md hover:shadow-xl duration-500' style='    border: solid;    border-radius: 5px;    border-color: gray;'>";
        echo "<a href='product.php?productName={$productName}'>";
        echo "<span style='top: 5px;    left: 5px;    border-radius: 4px;' class='yeni " . 
...
if (isset($_SESSION['user'])) {
    ...
    echo "</div>";
        ...
        echo "<div style='display: none; justify-content: space-between; align-items: center;'>";
